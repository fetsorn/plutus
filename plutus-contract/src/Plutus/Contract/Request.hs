...
awaitUtxoSpentOld utxo = pabReq (AwaitUtxoSpentReqOld utxo) E._AwaitUtxoSpentRespOld
...
awaitUtxoSpent utxo = fromOnChainTx <$> pabReq (AwaitUtxoSpentReqOld utxo) E._AwaitUtxoSpentRespOld
...
awaitUtxoProducedOld address = pabReq (AwaitUtxoProducedReqOld address) E._AwaitUtxoProducedRespOld
...
awaitUtxoProduced address =
  fmap fromOnChainTx <$> pabReq (AwaitUtxoProducedReqOld address) E._AwaitUtxoProducedRespOld
